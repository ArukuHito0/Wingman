 ...
 * ルームマッチングを管理するクラス
 * 
 * @method int create_room(string $password) 新規ルーム作成
 * @method int find_password_room(string $password) ルーム検索(合言葉あり)
 * @method int find_free_room() ルーム検索(合言葉なし)
 * @method void join_room(int $roomId, int $playerId) ルーム参加
 * @method void leave_room(int $playerId) ルーム退出
 * @method bool is_connect_players(int $roomId) ルームのプレイヤーが2人揃っていたらtrueを返す
 * @method void start_game(int $roomId) ルームの状態をゲームプレイ中に変更する
 */
class Matching
{
    private PDO $db;
